...
Revision ID: b1d1acfbdb3c
Revises: c59d1eb73cae
Create Date: 2025-07-14 09:45:25.511804
...
revision: str = 'b1d1acfbdb3c'
down_revision: Union[str, Sequence[str], None] = 'c59d1eb73cae'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['fieldId'], ['fields.id'], ),
    sa.ForeignKeyConstraint(['regionId'], ['regions.id'], ),
