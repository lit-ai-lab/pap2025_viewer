...
Revision ID: d5ccb3e6dfb2
Revises: dbbabbb9599b
Create Date: 2025-07-16 08:46:36.658976
...
revision: str = 'd5ccb3e6dfb2'
down_revision: Union[str, Sequence[str], None] = 'dbbabbb9599b'
...
def upgrade() -> None:
    ...
    sa.Column('specialCase', sa.Text(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
